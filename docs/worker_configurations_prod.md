...
1. [Launch the Add Worker Configuration wizard](worker_configuration_wizard_prod.md).
2. [Specify general settings for the worker configuration](worker_configuration_general_prod.md).
