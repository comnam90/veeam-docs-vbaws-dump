...
The list of available regions will depend on the option you have selected at [step 3](add_policy_scope_fsx.md) of the wizard. If you have selected the Organization option, the list will contain all existing AWS Regions; if you have selected the Account option, the list will contain all AWS Regions enabled for the AWS account.

1. To save changes made to the backup policy settings, click Apply.

[![Creating FSx Backup Policy](images/backup_add_regions_fsx.webp)](images/backup_add_regions_fsx.webp "Creating FSx Backup Policy")

Step 4b. Select FSx File Systems

In the Resources section of the Resources step of the wizard, specify the backup scope — select FSx file systems that Veeam Backup for AWS will back up:
