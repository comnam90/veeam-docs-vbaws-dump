---
title: "perform_redshift_serverless_backup"
...
* Check the limitations and prerequisites described in [Considerations and Limitations](limitations.md#backup_redshift_serverless).
