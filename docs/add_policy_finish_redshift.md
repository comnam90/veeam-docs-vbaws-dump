---
title: "add_policy_finish_redshift"
product: "vbaws"
doc_type: "guide"
source_url: "https://helpcenter.veeam.com/docs/vbaws/guide/add_policy_finish_redshift.html"
...
At the Summary step of the wizard, it is recommended that you run the backup policy configuration check before you click Finish — to do that, click Test Configuration. Depending on the option selected at [step 3](add_policy_scope_redshift.md) of the wizard, the following will happen:
...
[![Creating Redshift Backup Policy](images/backup_add_finish_redshift.webp)](images/backup_add_finish_redshift.webp "Creating Redshift Backup Policy")
