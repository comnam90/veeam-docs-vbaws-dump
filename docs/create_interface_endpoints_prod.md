...
1. At the Services step, enter Interface in the search field and choose a service for which you want to create a VPC endpoint.
...
2. At the Security groups step, choose security groups that will be associated with the endpoint network interfaces.
