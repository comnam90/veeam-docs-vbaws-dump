...
* [Deploy new Veeam Backup for AWS appliances](deploying_appliances.md) from the Veeam Backup & Replication console.
* [Connect to existing Veeam Backup for AWS appliances](connect_appliance.md) if you have already deployed them.
