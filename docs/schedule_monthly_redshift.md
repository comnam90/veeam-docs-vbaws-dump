---
title: "schedule_monthly_redshift"
product: "vbaws"
doc_type: "guide"
source_url: "https://helpcenter.veeam.com/docs/vbaws/guide/schedule_monthly_redshift.html"
...
If a restore point is older than the specified time limit, Veeam Backup for AWS removes the restore point from the chain. For more information, see [Redshift Backup Retention](retention_backup_redshift.md).
...
[![Creating Redshift Backup Policy](images/schedule_monthly_redshift.webp)](images/schedule_monthly_redshift.webp "Creating Redshift Backup Policy")
