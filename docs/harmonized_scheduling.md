...
source_url: "https://helpcenter.veeam.com/docs/vbaws/guide/harmonized_scheduling.html"
...
| --- |
| Note |
| Restore points created according to a more-frequent schedule and less-frequent schedules compose a single backup or snapshot chain. This means that regardless of flags assigned to restore points, Veeam Backup for AWS adds the restore points to the chain as described in sections [Backup Chain](backup_chain.md) and [Snapshot Chain](snapshot_chain.md). |
...
[![Enabling Harmonized Scheduling](images/retention_snapshots_daily_weekly.webp)](images/retention_snapshots_daily_weekly.webp "Enabling Harmonized Scheduling")
...
[![Enabling Harmonized Scheduling](images/retention_snapshots_daily_removed.webp)](images/retention_snapshots_daily_removed.webp "Enabling Harmonized Scheduling")
...
[![Enabling Harmonized Scheduling](images/retention_snapshots_daily_rp_removed.webp)](images/retention_snapshots_daily_rp_removed.webp "Enabling Harmonized Scheduling")

1. Veeam Backup for AWS will continue creating restore points for the next week in the same way as described in steps 1–4.

1. On week 3, after a backup session runs at 7:00 AM on Monday, the number of weekly restore points will exceed the retention limit. Veeam Backup for AWS will unassign the (W) flag from the earliest weekly restore point. Since no other flags are assigned to this restore point, Veeam Backup for AWS will remove this restore point from the snapshot chain.

[![Enabling Harmonized Scheduling](images/retention_snapshots_weekly_rp_removed.webp)](images/retention_snapshots_weekly_rp_removed.webp "Enabling Harmonized Scheduling")
