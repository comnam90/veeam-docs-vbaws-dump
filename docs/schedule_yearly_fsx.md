...
If a restore point is older than the specified time limit, Veeam Backup for AWS removes the restore from the chain. For more information, see [FSx Backup Retention](retention_backup_fsx.md).
