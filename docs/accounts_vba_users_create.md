...
1. [Launch the Add Portal Account wizard](user_account_wizard.md).
2. [Choose an account type](user_account_type.md).
3. [Specify an account name and description](user_account_name.md).
