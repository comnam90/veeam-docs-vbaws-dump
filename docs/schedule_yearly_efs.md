---
title: "schedule_yearly_efs"
product: "vbaws"
doc_type: "guide"
source_url: "https://helpcenter.veeam.com/docs/vbaws/guide/schedule_yearly_efs.html"
...
If a restore point is older than the specified time limit, Veeam Backup for AWS removes the restore from the chain. For more information, see [EFS Backup Retention](retention_backup_efs.md).
...
[![Creating EFS Backup Policy](images/schedule_yearly_efs.webp)](images/schedule_yearly_efs.webp "Creating EFS Backup Policy")
