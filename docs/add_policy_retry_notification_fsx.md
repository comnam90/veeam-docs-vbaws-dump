---
title: "add_policy_retry_notification_fsx"
source_url: "https://helpcenter.veeam.com/docs/vbaws/guide/add_policy_retry_notification_fsx.html"
...
| --- |
| Note |
| To be able to specify email notification settings for the FSx Backup policy, you must configure [global notification settings](email_settings.md) first. |
...
[![Creating FSx Backup Policy](images/backup_add_retry_notification_fsx.webp)](images/backup_add_retry_notification_fsx.webp "Creating FSx Backup Policy")
