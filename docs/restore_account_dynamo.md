---
title: "restore_account_dynamo"
source_url: "https://helpcenter.veeam.com/docs/vbaws/guide/restore_account_dynamo.html"
...
For an IAM role to be displayed in the list of available roles, it must be added to Veeam Backup for AWS with the Amazon DynamoDB Restore operation selected as described in section [Adding IAM Roles](iam_roles_add.md). If you have not added the necessary IAM role to Veeam Backup for AWS beforehand, you can do it without closing the DynamoDB Table Restore wizard. To do that, click Add and complete the Add IAM Role wizard.
...
[![Restoring DynamoDB Tables](images/restore_account_dynamo.webp)](images/restore_account_dynamo.webp "Restoring DynamoDB Tables")
