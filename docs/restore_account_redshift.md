---
title: "restore_account_redshift"
source_url: "https://helpcenter.veeam.com/docs/vbaws/guide/restore_account_redshift.html"
...
For an IAM role to be displayed in the list of available roles, it must be added to Veeam Backup for AWS with the Amazon Redshift Restore operation selected as described in section [Adding IAM Roles](iam_roles_add.md). If you have not added the necessary IAM role to Veeam Backup for AWS beforehand, you can do it without closing the Redshift Cluster Restore wizard. To do that, click Add and complete the Add IAM Role wizard.
...
[![Restoring Redshift Clusters](images/restore_account_redshift.webp)](images/restore_account_redshift.webp "Restoring Redshift Clusters")
