...
| --- |
| Note |
| To be able to specify email notification settings for the DynamoDB Backup policy, you must configure [global notification settings](email_settings.md) first. |
