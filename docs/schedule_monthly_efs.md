---
title: "schedule_monthly_efs"
source_url: "https://helpcenter.veeam.com/docs/vbaws/guide/schedule_monthly_efs.html"
...
| --- |
| Note |
| Veeam Backup for AWS does not create backup copies independently from EFS backups. That is why when you select hours for backup copies, the same hours are automatically selected for backups. To learn how Veeam Backup for AWS performs backup, see [EFS Backup](backup_hiw_efs.md). |
...
[![Creating EFS Backup Policy](images/schedule_monthly_efs.webp)](images/schedule_monthly_efs.webp "Creating EFS Backup Policy")
