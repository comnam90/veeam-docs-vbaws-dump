...
1. At the Account Name step of the wizard, enter a name and provide a description for the SMTP account. The name must be unique in Veeam Backup for AWS and the length of the name must not exceed 255 characters. The length must not exceed 255 characters.
